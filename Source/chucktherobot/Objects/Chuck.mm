...
- (void) hit
{
	...
	self.hitSoundPlaying = [[SimpleAudioEngine sharedEngine] playEffect: [NSString stringWithFormat: @"Media/Audio/general/chuck_hit/chuck_hit%d.aiff", arc4random() % self.hitSounds]];
}
